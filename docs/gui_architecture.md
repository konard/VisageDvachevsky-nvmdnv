...
> **Примечание**: Для актуальных статусов реализации см. [IMPLEMENTATION_ROADMAP.md](IMPLEMENTATION_ROADMAP.md).
> Для критериев 100% готовности редактора см. [EDITOR_SPEC_100.md](EDITOR_SPEC_100.md).
